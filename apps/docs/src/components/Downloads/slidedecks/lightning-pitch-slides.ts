...
export const lightningPitchSlides: Slide[] = [
  ...
  // ==========================================
  {
    ...
    script:
      "Two founders full-time with skin in the game. Jurie on AI and tech, Pieter on hardware with medical device manufacturing experience. Strategic advisors in finance, defense, and government relations.",
  },
