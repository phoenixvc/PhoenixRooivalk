...
// =============================================================================
// FPS BENCHMARKS BY CONFIGURATION
// =============================================================================
...
// =============================================================================
// UPGRADE CONFIGURATIONS & COST COMPARISONS
// =============================================================================
...
export interface UpgradeConfig {
  ...
  baseCost: number;
  upgradeName: string;
  upgradeComponents: { item: string; cost: number }[];
  totalCost: number;
  fpsImprovement: string;
  recommendedFor: string;
}

/** SkyWatch Standard upgrade paths */
export const skyWatchStandardUpgrades: UpgradeConfig[] = [
  {
    baseProduct: "SkyWatch Standard",
    baseCost: 209.99,
    upgradeName: "Hailo-8L Upgrade",
    upgradeComponents: [
      { item: "Replace Pi 4 with Pi 5 (4GB)", cost: 15 }, // $60 - $45
      { item: "Raspberry Pi AI Kit (Hailo-8L)", cost: 70 },
      { item: "Remove Coral USB", cost: -59.99 },
    ],
    totalCost: 235,
    fpsImprovement: "25 FPS → 45 FPS (+80%)",
    recommendedFor: "Commercial properties wanting faster detection",
  },
  {
    baseProduct: "SkyWatch Standard",
    baseCost: 209.99,
    upgradeName: "Jetson Orin Nano Upgrade",
    upgradeComponents: [
      { item: "Replace Pi 4 + Coral with Jetson Orin Nano 8GB", cost: 154 }, // $249 - $45 - $60
      { item: "Carrier board (if using module)", cost: 100 },
    ],
    totalCost: 404,
    fpsImprovement: "25 FPS → 60 FPS (+140%)",
    recommendedFor: "Multi-camera setups, advanced analytics",
  },
];

/** SkyWatch Pro upgrade paths */
export const skyWatchProUpgrades: UpgradeConfig[] = [
  {
    baseProduct: "SkyWatch Pro",
    baseCost: 495,
    upgradeName: "Hailo-8 Full Upgrade",
    upgradeComponents: [
      { item: "Upgrade Pi 5 to 8GB", cost: 20 }, // $80 - $60
      { item: "Replace Coral M.2 with Hailo-8", cost: 114 }, // $149 - $35
    ],
    totalCost: 629,
    fpsImprovement: "35 FPS → 55 FPS (+57%)",
    recommendedFor: "Maximum Pi-based performance",
  },
  {
    baseProduct: "SkyWatch Pro",
    baseCost: 495,
    upgradeName: "Jetson Orin NX Upgrade",
    upgradeComponents: [
      { item: "Replace Pi 5 + Coral with Jetson Orin NX 8GB", cost: 304 }, // $399 - $60 - $35
      { item: "Carrier board", cost: 150 },
    ],
    totalCost: 899,
    fpsImprovement: "35 FPS → 90 FPS (+157%)",
    recommendedFor: "Enterprise, multi-stream processing",
  },
];

/** Platform cost comparison (total system cost) */
export const platformCostComparison = {
...
export const valueAnalysis = {
  bestValue: {
    tier: "Commercial",
    config: "Pi 5 (4GB) + Hailo-8L AI Kit",
    cost: 130,
    fps: 45,
    costPerFps: 2.89,
    notes: "Best cost-per-FPS, official Pi support, easy setup",
  },
  bestPerformance: {
    tier: "Enterprise",
    config: "Jetson AGX Orin (64GB)",
    cost: 1999,
    fps: "275 TOPS",
    streams: "6+ simultaneous",
    notes: "Maximum performance, ruggedization available",
  },
  budgetChoice: {
    tier: "Residential",
    config: "Pi 4 (2GB) + Coral USB",
    cost: 105,
    fps: 25,
    costPerFps: 4.2,
    notes: "Proven reliable, wide software support",
  },
  futureProof: {
    tier: "Professional",
    config: "Jetson Orin Nano (8GB)",
    cost: 499,
    fps: 60,
    features: "CUDA, TensorRT, multi-stream",
    notes: "Room to grow, NVIDIA ecosystem",
  },
};

/** When to choose Pi vs Jetson */
export const platformSelectionGuide = {
  choosePi: [
    "Budget under $300 for compute",
    "Single camera detection",
    "Simple deployment requirements",
    "Community/hobbyist support preferred",
    "Standard 720p-1080p detection sufficient",
    "GPIO/HAT ecosystem important",
  ],
  chooseJetson: [
    "Multi-camera (2+) requirements",
    "4K video processing needed",
    "Advanced ML models (segmentation, pose)",
    "CUDA/TensorRT optimization required",
    "Rugged/industrial deployment",
    "Future expansion planned",
    "Budget allows $500+ for compute",
  ],
  choosePiWithHailo: [
    "Best of both: Pi ecosystem + high performance",
    "Commercial deployments under $200 compute",
    "Official Raspberry Pi support wanted",
    "45+ FPS @ 720p required",
