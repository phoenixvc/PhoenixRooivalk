...
- **Slow Response Times**: {PERFORMANCE.COMPETITOR_RESPONSE_TIME} too slow for fast-moving threats
...
**{PHASES.SERIES_A.shortName}: Defense Market Penetration ({PHASES.SERIES_A.timeline})**
...
**{PHASES.SERIES_B.shortName}: Critical Infrastructure ({PHASES.SERIES_B.timeline})**
