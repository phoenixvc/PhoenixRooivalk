...
<ApplicationDocument
  ...
  versionHistory={[
    { version: "1.0", date: "Dec 15, 2025", changes: "Initial draft submission" },
    { version: "0.9", date: "Dec 10, 2025", changes: "Added Canadian content section" },
    { version: "0.8", date: "Dec 5, 2025", changes: "Technical specifications review" },
  ]}
  checklist={[
