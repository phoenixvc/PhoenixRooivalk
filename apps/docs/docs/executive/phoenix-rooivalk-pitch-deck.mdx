...
<SlideDeck
  title="Phoenix Rooivalk: Quick Pitch"
  duration={3}
...
<SlideSection
  ...
  icon="🚨"
  keyPoints={[
    "Problem: Drones = 15% casualties in Ukraine, 1M+ produced in 2024",
    "Existing systems: 5-30s response, no offline capability, no legal evidence",
    "Our solution: Sub-200ms response, true autonomy, blockchain evidence",
    "💥 10-150x faster than all competitors",
  ]}
  script="Drones account for 15% of casualties in modern warfare. Ukraine alone produced over 1 million drones in 2024. Existing counter-drone systems are too slow at 5-30 seconds, fail offline, and provide no legal accountability. Phoenix Rooivalk delivers sub-200ms response times - that's 10 to 150 times faster - with true offline autonomy and blockchain-anchored evidence for legal defense."
/>
...
<SlideSection
  ...
  icon="📈"
  keyPoints={[
    "💰 Market: $2.51B by 2030 at 23.5% CAGR",
    "✅ x402 protocol live - generating revenue before hardware",
    "🚀 Net launcher prototype ready - 60% cost reduction",
    "🌍 EU & Canada priority markets (validated)",
  ]}
  script="We're targeting a $2.51 billion market growing at 23.5% annually. The x402 protocol is live today, generating revenue before hardware ships. Net launcher prototype is ready with 60% cost reduction through in-house Kevlar manufacturing. Market validation confirms EU and Canada as priority markets with immediate need."
/>
...
<SlideSection
  ...
  icon="⚡"
  keyPoints={[
    "🧠 Edge AI: All processing on-device, no cloud dependency",
    "⛓️ Blockchain: Solana + EtherLink for tamper-proof evidence",
    "🎯 Modular weapons: Nets, RF jammers, kinetic options",
    "🏆 Only solution with blockchain evidence generation",
  ]}
  script="Our edge-first AI processes everything on-device with no cloud dependency. Blockchain provides immutable evidence using Solana and EtherLink. Modular weapon system adapts to any threat and regulatory environment. We're the only solution that generates blockchain-based legal evidence."
/>

<SlideSection
  number={4}
  title="Business Model & Velocity"
  duration={35}
  icon="💰"
  keyPoints={[
    "💵 Pre-hardware revenue: x402 API live today",
    "📊 Hardware + SaaS: 65-70% margins",
    "⚡ Engineering velocity: 370+ commits in Week 48",
    "✅ Production-ready platform deployed",
  ]}
  script="Revenue starts before hardware ships through our x402 protocol. Business model combines hardware and SaaS with 65-70% gross margins. Engineering velocity is exceptional - 370+ commits in Week 48 alone. The platform is production-ready and fully deployed."
/>
...
<SlideSection
  ...
  keyPoints={[
    ...
    "📍 Use: Hardware (30%), Market entry (40%), Team (30%)",
    "✅ Milestones: 5 pilots, 10 x402 customers, certifications",
    "⏱️ 18-month runway to Series A with proven revenue",
  ]}
  script="We're raising $500K to $1M seed round. Funds go to hardware prototyping, EU and Canada market entry, and team expansion. Target milestones are 5 pilot installations, 10 x402 enterprise customers, and regulatory certifications. This provides 18 months to Series A with proven revenue traction. Questions?"
/>
