...
tags:
  - executive
  - counter-uas
phase: ["series-a", "series-b", "scale"]
---

import { MARKET, HARDWARE, BLOCKCHAIN, MANUFACTURING, TEAM, PRICING, FUNDING, PERFORMANCE, CAPITAL } from "@site/src/data/values";
...
operating under a dual entity structure: {TEAM.COMPANY_STRUCTURE} for US/ITAR markets and
...
- **In-House Advantages**: IP control, rapid iteration, {MANUFACTURING.COST_REDUCTION} cost reduction at
  scale
...
1. **{BLOCKCHAIN.PRIMARY_CHAIN}** - {BLOCKCHAIN.TPS_REAL_WORLD} TPS, {BLOCKCHAIN.COST_PER_TX}/transaction, {BLOCKCHAIN.FINALITY} finality
...
- Year 1: {MANUFACTURING.YEAR_1_SYSTEMS} complete systems (prototype/demonstration)
...
- In-house cost: {MANUFACTURING.INHOUSE_COST} ({PRICING.INHOUSE_COST_USD}) per complete system
- Outsourced cost: {MANUFACTURING.OUTSOURCED_COST} ($93,000) per system
- Gross margin improvement: {MANUFACTURING.COST_REDUCTION} to {PRICING.GROSS_MARGIN}
...
**Total Funding Needed: {CAPITAL.TOTAL_FUNDING_ZAR} ({CAPITAL.TOTAL_FUNDING_USD})**
...
With proper execution, Phoenix Rooivalk can capture 5-15% of the {MARKET.PROJECTED} global
