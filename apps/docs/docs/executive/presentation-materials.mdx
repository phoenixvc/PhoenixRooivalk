...
} from "@site/src/components/Downloads/slidedecks/presentation-materials-slides";
...
<SlideDeckDownload
  title={presentationMaterialsMeta.title}
  duration={presentationMaterialsMeta.duration}
  slides={presentationMaterialsSlides}
  audience={presentationMaterialsMeta.audience}
  date={presentationMaterialsMeta.date}
/>
