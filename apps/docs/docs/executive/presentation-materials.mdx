...
## 6-Slide Quick Presentation (3 Minutes)

<div style={{textAlign: 'center', marginBottom: '2rem'}}>
  <img src="/img/logo.svg" alt="Phoenix Rooivalk" style={{height: '60px', marginBottom: '1rem'}} />
  <div style={{fontSize: '0.875rem', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.5rem'}}>
    <strong>Presenter:</strong> Martyn Redelinghuys, Co-Founder & CEO | <strong>Date:</strong> December 2, 2025
  </div>
</div>

<SlideDeck
  title="PhoenixRooivalk: Quick Executive Presentation"
  duration={3}
...
<SlideSection
  ...
  icon="🛡️"
  keyPoints={[
    "⚠️ Challenge: 300% increase in drone swarms, 64% bypass current systems",
    "❌ Current defenses: 2-5s response, cloud-dependent, no legal evidence",
    "✅ Phoenix Rooivalk: 120-195ms response (10-40x faster)",
    "🏆 True autonomy + blockchain evidence = game changer",
  ]}
  script="Modern drone threats are evolving faster than defenses. We're seeing a 300% increase in coordinated swarm attacks, and RF-silent autonomous drones bypass 64% of current systems. Existing defenses are too slow at 2-5 seconds and fail when communications are jammed. Phoenix Rooivalk delivers 120-195ms response times - 10 to 40 times faster - with true offline autonomy and blockchain-verified evidence that's court-admissible."
/>
...
<SlideSection
  ...
  icon="⚡"
  keyPoints={[
    "🧠 Morpheus AI: Decentralized peer-to-peer agents with edge processing",
    "⛓️ Solana Blockchain: 3,000-4,500 TPS, $0.0003 per anchor",
    "🌐 Cognitive Mesh: Coordinates 100-200 drone swarm responses",
    "📡 Custom Sensor Fusion: RF, EO/IR, radar, acoustic - 30-50ms processing",
  ]}
  script="Our technology has four pillars. The Morpheus AI Decision Engine uses decentralized peer-to-peer agents with explainable AI. Solana blockchain provides 3,000-4,500 transactions per second with 400ms finality at just $0.0003 per anchor. Cognitive Mesh Orchestration coordinates responses to massive drone swarms. And our custom sensor fusion integrates multiple sensor types with 30-50ms processing time."
/>
...
<SlideSection
  ...
  icon="📈"
  keyPoints={[
    "💰 Market: $2.45-3.0B (2025) → $9-15B (2030) at 23-27% CAGR",
    "📊 Revenue: Hardware (60%), SaaS (25%), Services (15%)",
    "🎯 Unit economics: 6:1 to 10:1 CLV:CAC ratio",
    "💎 Gross margins: 65-70% hardware, 80%+ software",
  ]}
  script="We're targeting a $2.45-3.0 billion market in 2025, growing to $9-15 billion by 2030 at 23-27% annually. Our hybrid business model generates 60% revenue from hardware, 25% from SaaS subscriptions, and 15% from services. Unit economics are strong with CLV to CAC ratios of 6 to 10 to 1. Gross margins are 65-70% on hardware and over 80% on software."
/>
...
<SlideSection
  ...
  icon="🏆"
  keyPoints={[
    "⚡ Speed: 120-195ms vs 2-5 seconds (edge-first architecture)",
    "🔒 Autonomy: SAE Level 4, operates under EW and GPS denial",
    "⚖️ Accountability: Only solution with blockchain evidence",
    "🔐 Quantum-resistant design for beyond 2030 security",
  ]}
  script="Our competitive advantage rests on three pillars. Speed: our 120-195ms response time comes from edge-first architecture that eliminates network latency. Autonomy: we provide SAE Level 4 autonomous decision making that operates under electronic warfare and GPS denial with no single point of failure. Accountability: blockchain-verified engagement records provide cryptographically anchored audit trails. We're the only solution with cryptographic ROE compliance proof and quantum-resistant design."
/>
...
<SlideSection
  ...
  keyPoints={[
    ...
    "🤝 Track record: Security audit passed, partnerships ongoing",
  ]}
  script="We have proven progress. Our software foundation is complete with operational pilot deployments. Security evaluation shows red-team assessment completed with all vulnerabilities patched. Next milestones: Q4 2026 full production deployment, Q1 2027 market expansion with Series B funding. We're in active discussions with Lockheed Martin and other strategic partners."
/>
...
<SlideSection
  ...
  icon="💎"
  keyPoints={[
    "💵 Total investment to TRL7: $43.5M across 3 phases",
    "📍 Phase 1: $3.5M (Architecture), Phase 2: $15M (Prototype), Phase 3: $25M (Integration)",
    "📈 Return potential: 10-15x Series A, $2B-$5B strategic exit",
    "🎯 Immediate: Series A $15M for MVP completion",
  ]}
  script="We're seeking $43.5 million total investment across three phases to reach TRL7. Phase 1 needs $3.5 million for architecture validation. Phase 2 requires $15 million for hardware demo. Phase 3 needs $25 million for field trials and certification. Series A offers 10-15x return potential with strategic acquisition potential of $2B-$5B. Let's discuss how you can be part of securing the future. Questions?"
/>
...
<SlideSection
  ...
  keyPoints={[
    ...
    "Presenter: Martyn Redelinghuys, Co-Founder & CEO",
    "Date: October 3, 2025",
    "Audience: [Customize based on audience]",
  ]}
  script="Welcome to PhoenixRooivalk - the world's first SAE Level 4 autonomous counter-UAS defense system. I'm Martyn Redelinghuys, Co-Founder and CEO. Today we'll show you how we're revolutionizing drone defense through edge AI and blockchain accountability."
/>
...
**Presenter**: Martyn Redelinghuys, Co-Founder & CEO **Date**: December 2, 2025
**Audience**: [Customize based on audience]
