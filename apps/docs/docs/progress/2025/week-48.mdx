...
<SlideSection
  ...
  keyPoints={[
    ...
    "Target: Insurance, legal, regulatory compliance markets",
    "Revenue before hardware ships - funds development"
  ]}
  script="x402 uses Solana for evidence verification micropayments. Each verification costs pennies, Solana fees are fraction of a cent. Target markets: insurance claims, legal evidence, regulatory compliance. Revenue stream active before hardware ships."
/>
