...
The RKV-M (Rooivalk Kinetic Vehicle - Modular) is the kinetic interceptor component of
the Phoenix Rooivalk counter-UAS system. This document details the powerplant trades
and specifications for the tilt-quad rotor configuration.

:::info Document Status

**One Page Brief** - Date: 2025-09-25
This document represents initial trade study results. Subject to revision as
...
platform. Specifications subject to change as development progresses.
