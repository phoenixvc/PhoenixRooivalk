...
3. **Modular C-UAS site** — 4-node detection perimeter + central command + RKV-M
   launch pad, deployable in <4 hours
4. **Secure by design** — HSM-backed crypto, FIPS 140-3, classified-capable
   comms channels
5. **Sustained operations** — 24/7/365 with hot-swappable modules and predictive
   maintenance
...
- **Threat prioritization** — weighted by range, closing speed, payload
  estimate, and RF signature
