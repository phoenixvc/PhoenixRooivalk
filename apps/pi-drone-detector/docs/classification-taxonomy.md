...
|-------|-----------------|----------------------|
| drone_* | Drone-vs-Bird, Anti-UAV, Roboflow, MAV-VID | 10,000+ |
| bird_* | Drone-vs-Bird, CUB-200, iNaturalist, eBird | 100,000+ |
| aircraft_* | OpenImages, Flickr, PlaneSpotters | 50,000+ |
| kite | OpenImages, Flickr, custom | 5,000+ |
| balloon_* | OpenImages, Flickr, custom | 10,000+ |
...
| debris_* | Custom collection required | 1,000+ (need to create) |
