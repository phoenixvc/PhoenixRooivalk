...
This directory contains all tooling configuration files for the PhoenixRooivalk
project.
...
- Root symlinks: `.eslintrc.js`, `.prettierrc`, `.prettierignore`,
  `.editorconfig`, `.markdownlint.json`, `clippy.toml`, `cspell.json`
