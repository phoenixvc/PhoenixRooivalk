...
2. [Segment Vocabulary](#2-segment-vocabulary)
   - [Org Codes (Ownership)](#21-org-codes-ownership)
   - [Environment Codes](#22-environment-codes)
   - [Project Codes (Per Org)](#23-project-codes-per-org)
   - [Type Codes](#24-type-codes)
   - [Region Codes](#25-region-codes)
...
7. [AI Usage Summary Block](#7-ai-usage-summary-copy-paste)
8. [Bicep Naming Module](#8-bicep-naming-module)
9. [Resource Discovery Commands](#9-resource-discovery-commands-azure-cli)
...
Valid type/region codes: MUST match the tables in the naming standard.
...
### 9.5 List non-compliant resource groups
...
### 9.6 Multi-subscription inventory
...
1. **High Priority:** Resources that affect custom domains (SWA, App Service)
2. **Medium Priority:** Database and storage resources (requires data migration)
3. **Low Priority:** Internal services (Functions, Key Vault)
