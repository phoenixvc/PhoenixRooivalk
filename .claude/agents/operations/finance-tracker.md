...
- `apps/docs/src/data/values.ts` — 834 lines: market size ($6.64B current,
  $20.31B projected), revenue targets (Year 1 $25M, Year 5 $500M ZAR),
  funding rounds, hardware specs, competitor data
- `apps/docs/src/data/pricing.ts` — 286 lines: segment pricing (military
  $75K, infrastructure $55K, commercial $35K), COGS breakdown (in-house $56K
  vs outsourced $93K), unit economics (CAC $50K ZAR, LTV $1.2M ZAR)
