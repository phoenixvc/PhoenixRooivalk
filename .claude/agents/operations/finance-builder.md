...
- Canonical financial data (docs-side, single source of truth for business docs):
  ...
  - `apps/docs/src/data/competitors.ts` — 6 competitors with pricing,
    response times, strengths/weaknesses
