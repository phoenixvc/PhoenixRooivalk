...
description: Manages environment variables, .env.example files, and secret hygiene
...
Current state:
- `scripts/validate-env.sh` — Validates URLs, DB URLs, required vars
  (supports docs, marketing, api, keeper)
